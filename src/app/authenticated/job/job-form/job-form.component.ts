...
export class JobFormComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.getAllSkill();
    this.getJobDetail();
    this.expiryDate = AppData.getExpiryDate(this.translateService);
  }
  ...
  onSubmit() {
    let params = {
      ...
      expiry_date: moment(moment(this.jobForm.value.expiryDate, AppConstant.DATE_FORMAT.GET)
        .toDate()).format(AppConstant.DATE_FORMAT.POST),
